package com.gaoan.forever.utils.math;
...
public class AmountUtils {
    ...
    /**金额为分的格式 */
    public static final String CURRENCY_FEN_REGEX = "^(([1-9]\\d{0,9})|0)(\\.\\d{1,2})?$";
     ...
     * @return
     */
    public static int changeY2FByInt(String amount){
     ...
     * @return
     */
    public static String changeY2FByString(String amount){
        String currency =  amount.replaceAll("\\$|\\￥|\\,", "");  //处理包含, ￥ 或者$的金额
        int index = currency.indexOf(".");
        int length = currency.length();
        Long amLong = 0l;
